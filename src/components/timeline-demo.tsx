...
export default function TimelineDemo() {
  const allEvents: EventData[] = [
    ...
    {
      title: "No Code AI Workshop (Sept' 26)",
      description:
        "Hosted by the Data Science Society (DSS), Google Crowdsource introduced freshers to the concept of crowdsourcing through an interactive and engaging experience. The event gave students a glimpse into how collective contributions can help improve technology and AI while encouraging them to actively participate in building better digital experiences.",
      images: [
        "/Events/NoCodeAI/1.jpeg",
        "/Events/NoCodeAI/2.jpeg",
        "/Events/NoCodeAI/3.jpeg",
        "/Events/NoCodeAI/4.jpeg",
        "/Events/NoCodeAI/5.jpeg",
      ],
    },
    {
      title: "Data Quest 2.0 (March' 26)",
      description:
        "Inspired by the mysterious and thrilling world of Stranger Things, Data Quest Season 2 challenged participants to navigate a series of data-driven tasks and mind-bending challenges, with each round testing their analytical skills, creativity, and teamwork. The event aimed to promote data literacy, problem-solving, and collaborative thinking while immersing participants in an engaging and dynamic experience inspired by the Upside Down.",
      images: [
        "/Events/DataQuest2.0/1.jpeg",
        "/Events/DataQuest2.0/2.jpeg",
        "/Events/DataQuest2.0/3.jpeg",
        "/Events/DataQuest2.0/4.jpeg",
        "/Events/DataQuest2.0/5.jpeg",
      ],
    },
    {
